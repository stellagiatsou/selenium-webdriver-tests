...
require "rspec"
require_relative "signup_page.rb"   #signup page
...
describe "Blog application" do
  describe "when signing up a new user"	do
      ...
      signup = SignupPage.new(@driver)    #we can user signup page object on the methods below
      ...
      users = UsersPage.new(@driver)    #we can user users page object on the methods below
