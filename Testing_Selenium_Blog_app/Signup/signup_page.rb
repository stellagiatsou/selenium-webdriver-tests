class SignupPage
  ...
  attr_reader :driver   #allow the web driver instance variable to be created in my test, and used throught the class

  # class methods
  def initialize(driver)
    @driver = driver  #will pass the driver to the attr_reader above
  end
